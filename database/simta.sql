...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2021 at 06:52 AM
...
--
-- Table structure for table `batas_bimbingan`
--

CREATE TABLE IF NOT EXISTS `batas_bimbingan` (
`id` int(2) NOT NULL,
...
--
-- Dumping data for table `batas_bimbingan`
--
...
--
-- Table structure for table `berkas_validasi`
--

CREATE TABLE IF NOT EXISTS `berkas_validasi` (
`id` int(255) NOT NULL,
...
--
-- Dumping data for table `berkas_validasi`
--
...
(36, '141402190', 'sempro', 'Tutorial_Setting_CI15.zip', 'Tutorial_Setting_CI.zip', '2018-12-12', NULL, 'submit', 'belum dikonfirmasi'),
(37, '141402190', 'uji_program', 'Tutorial_Setting_CI16.zip', 'Tutorial_Setting_CI.zip', '2018-12-12', NULL, 'submit', 'belum dikonfirmasi'),
(38, '141402190', 'semhas', 'Tutorial_Setting_CI17.zip', 'Tutorial_Setting_CI.zip', '2018-12-12', NULL, 'submit', 'belum dikonfirmasi'),
(39, '141402190', 'sidang', 'Tutorial_Setting_CI18.zip', 'Tutorial_Setting_CI.zip', '2018-12-12', NULL, 'submit', 'belum dikonfirmasi'),
(40, '141402190', 'validasi_aplikasi', 'TUBES_048,_119,151,153,115,_12011.zip', 'TUBES_048,_119,151,153,115,_1201.zip', '2018-12-12', NULL, 'submit', 'belum dikonfirmasi'),
(43, '141402180', 'sempro', 'SeminarProposal_141402180_AuliaAmirullah2.zip', 'SeminarProposal_141402180_AuliaAmirullah.zip', '2018-12-20', NULL, 'submit', 'belum dikonfirmasi'),
(44, '141402180', 'uji_program', 'UjiProgram_141402180_AuliaAmirullah1.zip', 'UjiProgram_141402180_AuliaAmirullah.zip', '2018-12-20', NULL, 'submit', 'belum dikonfirmasi'),
(45, '141402180', 'semhas', 'SeminarHasil_141402180_AuliaAmirullah.rar', 'SeminarHasil_141402180_AuliaAmirullah.rar', '2018-12-20', NULL, 'submit', 'belum dikonfirmasi'),
(46, '141402180', 'sidang', 'Sidang_141402180_AuliaAmirullah.zip', 'Sidang_141402180_AuliaAmirullah.zip', '2018-12-22', NULL, 'submit', 'belum dikonfirmasi'),
(47, '141402223', 'sempro', 'SeminarProposal_141402223_AbdulHakim.zip', 'SeminarProposal_141402223_AbdulHakim.zip', '2020-02-13', NULL, 'submit', 'belum dikonfirmasi');

-- --------------------------------------------------------

--
-- Table structure for table `berkas_validasi_penguji`
--

CREATE TABLE IF NOT EXISTS `berkas_validasi_penguji` (
`id` int(200) NOT NULL,
  `nim` int(9) NOT NULL,
...
--
-- Dumping data for table `berkas_validasi_penguji`
--

INSERT INTO `berkas_validasi_penguji` (`id`, `nim`, `cd`, `kode`, `jurnal`, `program`) VALUES
(1, 141402180, 'CdSkripsi_141402180_AuliaAmirullah7.rar', 'KodeAplikasi_141402180_AuliaAmirullah.rar', '', '');
...
--
-- Table structure for table `catatan_perbaikan_semhas`
--

CREATE TABLE IF NOT EXISTS `catatan_perbaikan_semhas` (
...
`id` int(225) NOT NULL,
  `untuk_seminar` enum('semhas','sidang') NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `catatan_perbaikan_semhas`
--

INSERT INTO `catatan_perbaikan_semhas` (`dosen`, `status_dosen`, `nim`, `id_pengajuan`, `id_jadwal_seminar`, `catatan_perbaikan`, `status_perbaikan`, `keterangan_catatan`, `kunci`, `id`, `untuk_seminar`) VALUES
('AML', 'pembimbing1', '141402190', '23', '8', 'test', 'belum', '', 'unlocked', 2, 'semhas'),
('ANL', 'pembimbing1', '141402180', '26', '8', 'oke', 'sudah', '', 'locked', 3, 'semhas'),
('ANL', 'pembimbing1', '141402180', '26', '8', 'test', 'sudah', '', 'locked', 4, 'semhas'),
('ANS', 'pembimbing2', '141402180', '26', '8', 'iiiiiiii', 'sudah', '', 'locked', 5, 'semhas'),
('ANL', 'pembimbing1', '141402180', '26', '13', 'abcjasdkjas sdafsdf', 'sudah', '', 'locked', 6, 'sidang'),
('ANS', 'pembimbing2', '141402180', '26', '13', 'gdsga fdsadf asfe', 'sudah', '', 'locked', 7, 'sidang'),
('ANS', 'pembimbing2', '141402180', '26', '13', 'sadf ewqfewfew', 'sudah', '', 'locked', 8, 'sidang'),
('BHQ', 'pembanding1', '141402180', '26', '13', 'erfhks dfjsdaf iewr', 'sudah', '', 'locked', 9, 'sidang'),
('ANL', 'pembimbing1', '141402180', '26', '11', 'sakd asjdnaskd', 'sudah', '', 'locked', 10, 'sidang');

-- --------------------------------------------------------

--
-- Table structure for table `catatan_perbaikan_sidang`
--

CREATE TABLE IF NOT EXISTS `catatan_perbaikan_sidang` (
`id` int(225) NOT NULL,
  `dosen` char(5) NOT NULL,
  `status_dosen` enum('pembimbing1','pembimbing2','pembanding1','pembanding2') NOT NULL,
  `nim` char(9) NOT NULL,
...
--
-- Dumping data for table `catatan_perbaikan_sidang`
--
...
(7, 'AML', 'pembimbing1', '141402190', '23', '11', 'Perbaiki judulnya', 'sudah', '', 'locked'),
(8, 'AML', 'pembimbing1', '141402190', '23', '11', 'asda asd', 'sudah', '', 'locked'),
(9, 'BHQ', 'pembanding1', '141402190', '23', '11', 'sdfsdf sdf', 'sudah', '', 'locked'),
(11, 'ANL', 'pembimbing1', '141402180', '26', '14', 'sajkd asjdnsa', 'sudah', 'jsdankas askd', 'locked'),
(12, 'BHQ', 'pembanding1', '141402180', '26', '14', 'jsdn sajnfdsanf asdf', 'sudah', '', 'locked'),
(13, 'ERN', 'pembanding2', '141402180', '26', '14', 'hjbjasbdjsad asdsfds', 'sudah', '', 'locked');
...
CREATE TABLE IF NOT EXISTS `disertasi` (
...
CREATE TABLE IF NOT EXISTS `dosen` (
  ...
  `Kode_PS` char(5) NOT NULL,
  `ttd` text NOT NULL,
  `status_bimbingan` enum('tetap','sementara') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `dosen` (`Kode_dosen`, `Nama_dosen`, `Pangkat`, `Golongan`, `NIP`, `NIDN`, `Kode_PS`, `ttd`, `status_bimbingan`) VALUES
('ADC', 'Ade Candra, S.T., M.Kom', '', '', '', '', 'ILK', '', 'tetap'),
('AML', 'Amalia, ST, MT', '', '', '', '', 'TIF', '1.jpg', 'tetap'),
('AMS', 'Amer sharif,S.Si.,M.Kom', '', '', '', '', 'ILK', '', 'tetap'),
('ANL', 'Ainul Hizriadi, S.Kom, M.Sc.', '', '', '', '', 'TIF', '7.jpg', 'tetap'),
('ANS', 'Ayu Nuriani Sebayang, S.Kom, M.Kom', '', '', '', '', 'ILK', '', 'tetap'),
('ASH', 'Drs Agus Salim Harahap, M.Si', '', '', '', '', 'ILK', '', 'tetap'),
('BHQ', 'Baihaqi Siregar, S.Si,M.T', '', '', '', '', 'TIF', '', 'tetap'),
('BM', 'Drs.BM Sembiring', '', '', '', '', 'TIF', '', 'tetap'),
('DDA', 'Dedy Arisandi, ST, M.Kom', '', 'III/c', '12345678910', '', 'TIF', '', 'tetap'),
('DGW', 'Dani Gunawan, ST, MT', '', '', '', '', 'TIF', '', 'tetap'),
('DLS', 'Drs. Dahlan Sitompul,M.Eng', '', '', '', '', 'ILK', '', 'tetap'),
('DRW', 'Dian Rachmawati,S.Si.,M.Kom', '', '', '', '', 'ILK', '', 'tetap'),
('ELV', 'Dr. Elviawaty Muisa Zamzami, ST, MT, MM', '', '', '', '', 'TIF', '', 'tetap'),
('ERN', 'Dr. Erna Budhiarti Nababan, M.IT', '', '', '', '', 'TIF', '', 'tetap'),
('EVW', 'Elviwani, S.T.,S.Kom.,M.Kom', '', '', '', '', 'ILK', '', 'tetap'),
('FDL', 'Mohammad Fadly Syahputra, B.Sc., M.Sc.IT', '', '', '', '', 'TIF', '', 'tetap'),
('HDZ', 'Handrizal, S.Si, M.Comp.Sc', '', '', '', '', 'ILK', '', 'tetap'),
('HYC', 'Herriyance, S.T., M.Kom', '', '', '', '', 'ILK', '', 'tetap'),
('INA', 'Indra Aulia,S.TI.M.Kom', '', '', '', '', 'TIF', '', 'tetap'),
('IRT', 'Prof. Dr. Irianto, M.Si', '', '', '', '', 'ILK', '', 'tetap'),
('IVAN', 'Ivan Jaya, S.Kom, M.Kom.', '', '', '', '', 'TIF', '', 'tetap'),
('JTT', 'Jos Timanta Tarigan, S.Kom., M.Sc.', '', '', '', '', 'TIF', '', 'tetap'),
('MAB', 'M. Andri Budiman, ST, M.Comp.Sc., M.E.M', '', '', '', '', 'TIF', '', 'tetap'),
('MAM', 'Muhammad Anggia Muchtar,ST,MM.IT', '', '', '', '', 'TIF', '', 'tetap'),
('MHS', 'Drs. Marihat Situmorang, M.Kom', '', '', '', '', 'ILK', '', 'tetap'),
('MSL', 'Dr. Maya Silvi Lydia, B.Sc., M.Sc.', '', '', '', '', 'TIF', '', 'tetap'),
('MYD', 'Dr.Mahyudin Nst, M.IT', '', '', '', '', 'TIF', '', 'tetap'),
('NO', 'Belum Ditentukan (Default)', '', '', '', '', 'NOM', '', 'tetap'),
('OPM', 'Prof. Dr. Opim Salim Sitompul, M.Sc.', '', '', '', '', 'TIF', '', 'tetap'),
('PLS', 'Dr. Poltak sihombing, M.Kom', '', '', '', '', 'ILK', '', 'tetap'),
('RMA', 'Rachmat Aulia, S.Kom, MSc', '', '', '', '', 'ILK', '', 'tetap'),
('ROM', 'Romi Fadillah Rahmat, B.Comp.Sc., M.Sc.', '', '', '', '', 'TIF', '', 'tetap'),
('SAF', 'M. Safri Lubis,ST, M.Com', '', '', '', '', 'TIF', '', 'tetap'),
('SAR', 'Sarah Purnamawati, ST, M.Sc.', '', '', '', '', 'TIF', '', 'tetap'),
('SDF', 'Siti Dara Fadilah, S.Si, M.IT', '', '', '', '', 'ILK', '', 'tetap'),
('SJS', 'Sajadin Sembiring, S.Si., M.Comp. Sc', '', '', '', '', 'ILK', '', 'tetap'),
('SMH', 'Sri Melvani Hardi, S.Kom., M.Kom', '', '', '', '', 'ILK', '', 'tetap'),
('SNM', 'Seniman, S.Kom, M.Kom', '', '', '', '', 'TIF', '', 'tetap'),
('SRS', 'Dr. Syahriol Sitorus, S.Si, M.IT', '', '', '', '', 'ILK', '', 'tetap'),
('SWD', 'Dr. Syawaluddin M.IT', '', '', '', '', 'TIF', '', 'tetap'),
('SYE', 'Dr. Syahril Efendi.S.Si,M.IT', '', '', '', '', 'ILK', '', 'tetap'),
('ULFI', 'Ulfi Andayani, S.Kom, M.Kom', '', '', '', '', 'TIF', '', 'tetap'),
('VEN', 'Marischa Elveny,S.Ti, M.Kom', '', '', '', '', 'TIF', '', 'tetap'),
('ZAR', 'Prof.Dr.Muhammad Zarlis', '', '', '', '', 'TIF', '', 'tetap'),
('QWO', 'Prof. Ir. Ahmad', '', '', '', '', '', '', 'sementara'),
('HXG', 'Prof. Ir. Irfandi', '', '', '', '', '', '', 'sementara'),
('MSF', 'ir. ahmad', '', '', '', '', '', '', 'sementara');

--
-- Triggers `dosen`
--
DELIMITER //
CREATE TRIGGER `update_dosen` AFTER UPDATE ON `dosen`
 FOR EACH ROW BEGIN
...
--
-- Table structure for table `gaji_dosen`
--

CREATE TABLE IF NOT EXISTS `gaji_dosen` (
...
--
-- Dumping data for table `gaji_dosen`
--
...
--
-- Table structure for table `izin_seminar`
--

CREATE TABLE IF NOT EXISTS `izin_seminar` (
`id` int(255) NOT NULL,
  `nim` char(9) NOT NULL,
...
--
-- Dumping data for table `izin_seminar`
--
...
(2, '141402157', 15, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', 'semhas', '0000-00-00'),
...
(7, '141402190', 23, '2018-12-12', '0000-00-00', '0000-00-00', '0000-00-00', 'sempro', '2018-12-21'),
(8, '141402190', 23, '2018-12-12', '0000-00-00', '0000-00-00', '0000-00-00', 'semhas', '2018-12-13'),
(9, '141402190', 23, '2018-12-12', '0000-00-00', '2018-12-12', '0000-00-00', 'sidang', '2018-12-13'),
(10, '141402180', 26, '2018-12-20', '2018-12-20', '0000-00-00', '0000-00-00', 'sempro', '2018-12-22'),
(11, '141402180', 26, '2018-12-22', '2018-12-22', '0000-00-00', '0000-00-00', 'semhas', '2018-12-24'),
(12, '141402180', 26, '2018-12-22', '2018-12-22', '2018-12-22', '2018-12-22', 'sidang', '2018-12-28'),
(13, '141402223', 29, '2020-02-13', '2020-02-13', '0000-00-00', '0000-00-00', 'sempro', '2020-02-14');
...
(10, 'seminar proposal', '2018-12-12', 9, '', '', 'akan datang'),
(11, 'sidang', '2018-12-28', 20, '', '', 'akan datang'),
(12, 'seminar proposal', '2018-12-21', 10, '', '', 'akan datang'),
(13, 'seminar hasil', '2018-12-29', 10, '', '', 'akan datang'),
(14, 'sidang', '2018-12-31', 10, '', '', 'akan datang'),
(16, 'seminar proposal', '2018-12-31', 10, '', '', 'akan datang'),
(17, 'seminar proposal', '2019-01-15', 10, '', '', 'akan datang'),
(18, 'seminar proposal', '2019-01-08', 10, '', '', 'akan datang'),
(19, 'seminar proposal', '2020-02-14', 8, '', '', 'akan datang'),
(20, 'seminar hasil', '2021-03-26', 10, '', '', 'akan datang');

-- --------------------------------------------------------

--
-- Table structure for table `kirim_aplikasi`
--

CREATE TABLE IF NOT EXISTS `kirim_aplikasi` (
`id` int(255) NOT NULL,
...
--
-- Dumping data for table `kirim_aplikasi`
--
...
--
-- Table structure for table `lembar_kendali_bimbingan`
--

CREATE TABLE IF NOT EXISTS `lembar_kendali_bimbingan` (
`id` int(255) NOT NULL,
  `nim` char(9) NOT NULL,
  ...
  `jenis_seminar` enum('sempro','semhas','sidang') NOT NULL,
  `repetisi` int(3) NOT NULL,
  `kunci` enum('unlocked','locked') NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `lembar_kendali_bimbingan`
--

INSERT INTO `lembar_kendali_bimbingan` (`id`, `nim`, `id_pengajuan`, `tgl_penyerahan`, `tgl_selesai_diperiksa`, `tgl_terima_kembali`, `catatan`, `pembimbing`, `jenis_seminar`, `repetisi`, `kunci`) VALUES
(3, '141402157', '15', '2018-11-14', '2018-11-16', '2018-11-21', 'Arsitektur Umum', 'pembimbing1', 'sempro', 0, 'locked'),
(4, '141402157', '15', '2018-11-15', '2018-11-16', '2018-11-20', 'Latar Belakang', 'pembimbing2', 'sempro', 0, 'locked'),
(5, '141402157', '15', '2018-11-06', '2018-11-14', '2018-11-16', 'Referensi ', 'pembimbing1', 'sempro', 0, 'locked'),
(7, '141402157', '15', '2018-11-21', '2018-11-23', '2018-11-26', 'Arsitektur Umum Arsitektur Umum ', 'pembimbing1', 'semhas', 0, 'locked'),
(8, '141402157', '15', '2018-11-21', '2018-11-22', '2018-11-23', 'Code Code Code Code', 'pembimbing1', 'semhas', 0, 'locked'),
(9, '141402157', '15', '2018-11-21', '2018-11-22', '2018-11-23', 'Code Code 2 2 2 2 2', 'pembimbing2', 'semhas', 0, 'locked'),
(10, '141402157', '15', '2018-11-21', '2018-11-22', '2018-11-29', 'sahdjasd asjkhdjasd asjhdjas djasd', 'pembimbing2', 'semhas', 0, 'locked'),
(11, '141402157', '15', '2018-11-22', '2018-11-23', '2018-11-30', 'sdfsdf sdf dsf sd f sdfsd', 'pembimbing1', 'semhas', 0, 'locked'),
(12, '141402157', '15', '2018-11-22', '2018-11-22', '2018-11-22', 'Perbaikan Seminar Hasil', 'pembimbing1', 'sidang', 0, 'locked'),
(14, '141402157', '15', '2018-11-22', '2018-11-22', '2018-11-23', 'Perbaikan Algoritma', 'penguji1', 'sidang', 0, 'locked'),
(15, '141402157', '15', '2018-11-23', '2018-11-23', '2018-11-23', 'asdhjaskd sasajhdas sajhdkajsd', 'pembimbing2', 'sidang', 0, 'locked'),
(16, '141402157', '15', '2018-11-27', '2018-11-29', '2018-11-30', 'uhsakdhask sahdkjas asdhias', 'penguji1', 'sidang', 0, 'locked'),
(17, '141402157', '15', '2018-11-23', '2018-11-23', '2018-11-22', 'sdfsadf ewfewas esafsadf', 'penguji2', 'sidang', 0, 'locked'),
(18, '141402220', '20', '2018-11-23', '2018-11-23', '2018-11-23', 'dskanjksa dwijsdwqs d', 'pembimbing1', 'sempro', 0, 'locked'),
(19, '141402220', '20', '2018-11-23', '2018-11-24', '2018-11-24', 'adssad sad asdasd', 'pembimbing1', 'sempro', 0, 'locked'),
(20, '141402220', '20', '2018-11-23', '2018-11-24', '2018-11-26', 'sandjsa dJSA DASIDAS', 'pembimbing2', 'sempro', 0, 'locked'),
(21, '141402220', '20', '2018-11-24', '2018-11-24', '2018-11-24', 'dbsahd ashdas diasd', 'pembimbing1', 'semhas', 0, 'locked'),
(22, '141402220', '20', '0000-00-00', '0000-00-00', '0000-00-00', 'jasdj asjdnas dasjdasd', 'pembimbing1', 'semhas', 0, 'locked'),
(23, '141402220', '20', '2018-11-24', '2018-11-24', '2018-11-24', 'sajdn asJDBAjs dashDSA', 'pembimbing2', 'semhas', 0, 'locked'),
(24, '141402220', '20', '2018-11-29', '2018-11-30', '2018-11-30', 'jsda asdjas DAIJSdas', 'pembimbing1', 'semhas', 0, 'locked'),
(25, '141402220', '20', '2018-11-30', '2018-11-30', '2018-11-30', 'kjabSDNA SDHBASdhas', 'pembimbing2', 'semhas', 0, 'locked'),
(26, '141402200', '22', '2018-11-26', '2018-11-26', '2018-11-26', 'Latar Belakang dan Referensi', 'pembimbing1', 'sempro', 0, 'locked'),
(27, '141402200', '22', '2018-11-26', '2018-11-26', '2018-11-26', 'Arsitektur Umum', 'pembimbing1', 'sempro', 0, 'locked'),
(28, '141402200', '22', '2018-11-26', '2018-11-26', '2018-11-26', 'Perbaikan', 'pembimbing2', 'sempro', 0, 'locked'),
(29, '141402190', '23', '2018-12-12', '2018-12-12', '2018-12-14', 'hbjhsabdjas', 'pembimbing1', 'sempro', 0, 'locked'),
(30, '141402190', '23', '2018-12-13', '2018-12-13', '2018-12-19', 'asdsadcas', 'pembimbing1', 'sempro', 0, 'locked'),
(31, '141402190', '23', '2018-12-12', '2018-12-12', '2018-12-12', 'asdasd sadsa', 'pembimbing2', 'sempro', 0, 'locked'),
(32, '141402190', '23', '2018-12-13', '2018-12-13', '2018-12-13', 'weadwdwad', 'pembimbing1', 'semhas', 0, 'locked'),
(33, '141402190', '23', '2018-12-13', '2018-12-13', '2018-12-13', 'asdas', 'pembimbing1', 'semhas', 0, 'locked'),
(34, '141402190', '23', '2018-12-13', '2018-12-13', '2018-12-12', 'wesdfsad', 'pembimbing2', 'semhas', 0, 'locked'),
(35, '141402190', '23', '2018-12-13', '2018-12-13', '2018-12-13', '', 'pembimbing1', 'semhas', 0, 'locked'),
(36, '141402190', '23', '2018-12-13', '2018-12-14', '2018-12-14', 'ewsdfsad', 'pembimbing2', 'semhas', 0, 'locked'),
(37, '141402190', '23', '2018-12-13', '2018-12-13', '2018-12-13', 'dsfsd sdfsdf', 'pembimbing1', 'sidang', 0, 'locked'),
(38, '141402190', '23', '2018-12-13', '2018-12-13', '2018-12-13', 'sadasd asd', 'pembimbing1', 'sidang', 0, 'locked'),
(39, '141402190', '23', '2018-12-20', '2018-12-13', '2018-12-13', 'asdasdas', 'pembimbing1', 'sidang', 0, 'locked'),
(40, '141402190', '23', '2018-12-13', '2018-12-13', '2018-12-13', 'asdasd', 'penguji1', 'sidang', 0, 'locked'),
(41, '141402190', '23', '2018-12-13', '2018-12-13', '2018-12-13', 'saedwae', 'pembimbing2', 'sidang', 0, 'locked'),
(42, '141402180', '26', '2018-12-21', '2018-12-21', '2018-12-21', 'ghvhgv bjh', 'pembimbing1', 'sempro', 0, 'locked'),
(43, '141402180', '26', '2018-12-21', '2018-12-21', '2018-12-21', 'hjgjhg jku', 'pembimbing1', 'sempro', 0, 'locked'),
(44, '141402180', '26', '2018-12-21', '2018-12-21', '2018-12-21', 'hjhgv gvhg', 'pembimbing2', 'sempro', 0, 'locked'),
(45, '141402180', '26', '2018-12-21', '2018-12-21', '2018-12-21', 'bhjhbjh', 'pembimbing1', 'semhas', 0, 'locked'),
(46, '141402180', '26', '2018-12-21', '2018-12-21', '2018-12-21', 'uyhb jbdwfj sdhfjsdf', 'pembimbing2', 'semhas', 0, 'locked'),
(47, '141402180', '26', '2018-12-21', '2018-12-21', '2018-12-21', 'dsjbfsd fhsdbf shfsad', 'pembimbing1', 'semhas', 0, 'locked'),
(48, '141402180', '26', '2018-12-21', '2018-12-21', '2018-12-21', 'sdaf sdf sfsd', 'pembimbing2', 'semhas', 0, 'locked'),
(49, '141402180', '26', '2018-12-21', '2018-12-21', '2018-12-21', 'sdfsadm fajsdfsa', 'pembimbing2', 'semhas', 0, 'locked'),
(50, '141402180', '26', '2018-12-24', '2018-12-23', '2018-12-24', 'kjansDJ SAjdnsa', 'pembimbing1', 'sidang', 0, 'unlocked'),
(51, '141402180', '26', '2018-12-24', '2018-12-24', '2018-12-24', 'asdn sadasnd', 'pembimbing1', 'sidang', 0, 'unlocked'),
(52, '141402180', '26', '2018-12-24', '2018-12-24', '2018-12-24', 'DSAM DSANDsjad', 'pembimbing2', 'sidang', 0, 'unlocked'),
(53, '141402180', '26', '2018-12-24', '2018-12-24', '2018-12-24', 'jnsda sajdsa', 'pembimbing2', 'sidang', 0, 'unlocked'),
(54, '141402180', '26', '2018-12-24', '2018-12-24', '2018-12-24', 'dnsa d jasdf jsad', 'pembimbing1', 'sidang', 0, 'unlocked'),
(55, '141402223', '29', '2020-02-13', '2020-02-13', '2020-02-14', 'erftgwrft', 'pembimbing1', 'sempro', 0, 'unlocked'),
(56, '141402223', '29', '2020-02-14', '2020-02-14', '2020-02-14', '4e2wrwe', 'pembimbing1', 'sempro', 0, 'unlocked'),
(57, '141402223', '29', '2020-02-14', '2020-02-15', '2020-02-17', 'werfweas', 'pembimbing2', 'sempro', 0, 'unlocked'),
(58, '141402223', '29', '2020-02-14', '2020-02-14', '2020-02-14', 'wertfwef ewdfwerfd', 'pembimbing1', 'sempro', 0, 'unlocked');
...
CREATE TABLE IF NOT EXISTS `log_pencatatan` (
`id` int(255) NOT NULL,
...
--
-- Dumping data for table `log_pencatatan`
--
...
(296, 'root@localhost', '141402190', 'judul', '2018-12-12 16:34:26'),
(297, 'root@localhost', '141402180', 'Judul IT', '2018-12-19 17:27:11'),
(298, 'root@localhost', '141402223', 'Sistem Keamanan Informasi dengan Algoritma A', '2020-02-13 17:46:45');
...
('141402157', 'Charissa ', 'TIF', 'belum sidang', '', '0', '0', '0', '0', '0'),
('141402158', 'Raisya', 'TIF', 'belum sempro', '', '1', '1', '1', '1', '1'),
('141402180', 'Aulia Amirullah', 'TIF', 'sudah sidang', '', '0', '0', '0', '1', '0'),
('141402190', 'Muhammad Arief', 'TIF', 'lulus', '', '0', '0', '0', '0', '0'),
('141402199', '141402199', 'TIF', 'pengajuan judul', '', '1', '1', '1', '1', '1'),
('141402200', '141402200', 'TIF', 'pengajuan judul', '', '1', '0', '1', '1', '1'),
('141402201', 'Ahmad Nasution', 'TIF', 'pengajuan judul', '', '1', '1', '1', '1', '1'),
('141402202', '141402202', 'TIF', 'pengajuan judul', '', '1', '1', '1', '1', '1'),
('141402220', '141402220', 'TIF', 'belum semhas', '', '0', '0', '1', '1', '0'),
('141402222', 'Abdullah', 'TIF', 'pengajuan judul', '', '1', '1', '1', '1', '1'),
('141402223', 'Abdul Hakim', 'TIF', 'belum semhas', '', '0', '1', '1', '1', '1'),
('141402330', '141402330', 'TIF', 'pengajuan judul', '', '1', '1', '1', '1', '1'),
('141402400', '141402400', 'TIF', 'pengajuan judul', '', '1', '1', '1', '1', '1'),
...
--
-- Table structure for table `mahasiswa_sidang`
--

CREATE TABLE IF NOT EXISTS `mahasiswa_sidang` (
`id` int(9) NOT NULL,
  `id_jadwal_seminar` int(9) NOT NULL,
  `nim` char(9) NOT NULL,
  `id_pengajuan` char(200) NOT NULL,
  `status_kelayakan` enum('belum dikonfirmasi','layak','tidak layak') NOT NULL,
  `status_dilihat` enum('belum','sudah') NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `mahasiswa_sidang`
--

INSERT INTO `mahasiswa_sidang` (`id`, `id_jadwal_seminar`, `nim`, `id_pengajuan`, `status_kelayakan`, `status_dilihat`) VALUES
(1, 2, '141402153', '1', 'belum dikonfirmasi', 'sudah'),
(2, 3, '141402153', '2', 'belum dikonfirmasi', 'sudah'),
(3, 4, '141402153', '2', 'belum dikonfirmasi', 'sudah'),
(4, 5, '141402153', '2', 'belum dikonfirmasi', 'sudah'),
(5, 6, '191402001', '4', 'belum dikonfirmasi', 'belum'),
(6, 7, '191402001', '4', 'belum dikonfirmasi', 'belum'),
(7, 8, '191402001', '4', 'belum dikonfirmasi', 'belum'),
(8, 9, '191402001', '4', 'belum dikonfirmasi', 'belum'),
(9, 6, '201402001', '5', 'belum dikonfirmasi', 'belum'),
(10, 7, '201402001', '5', 'belum dikonfirmasi', 'belum'),
(11, 9, '201402001', '5', 'belum dikonfirmasi', 'belum'),
(12, 6, '141402157', '15', 'layak', 'belum'),
(13, 7, '141402157', '15', 'layak', 'belum'),
(14, 9, '141402157', '15', 'layak', 'belum'),
(15, 6, '141402220', '20', 'layak', 'belum'),
(16, 7, '141402220', '20', 'belum dikonfirmasi', 'belum'),
(17, 6, '141402200', '22', 'tidak layak', 'sudah'),
(18, 10, '141402190', '23', 'layak', 'belum'),
(19, 8, '141402190', '23', 'layak', 'belum'),
(20, 11, '141402190', '23', 'layak', 'belum'),
(21, 12, '141402180', '26', 'layak', 'sudah'),
(22, 8, '141402180', '26', 'tidak layak', 'sudah'),
(23, 13, '141402180', '26', 'layak', 'sudah'),
(24, 11, '141402180', '26', 'tidak layak', 'sudah'),
(25, 14, '141402180', '26', 'layak', 'sudah'),
(26, 19, '141402223', '29', 'layak', 'sudah');
...
(336, '141402190', 90.000, 56.500, 82.500, 129.200, 'A'),
(337, '141402180', 90.000, 96.333, 99.999, 76.900, 'B+'),
(338, '141402180', 90.000, 96.333, 99.999, 76.900, 'B+'),
(339, '141402199', NULL, NULL, NULL, 0.000, NULL),
(340, '141402222', NULL, NULL, NULL, 0.000, NULL),
(341, '141402223', NULL, NULL, NULL, 0.000, NULL),
(342, '141402330', NULL, NULL, NULL, 0.000, NULL),
(343, '141402400', NULL, NULL, NULL, 0.000, NULL);
...
--
-- Table structure for table `notifikasi_dosen`
--

CREATE TABLE IF NOT EXISTS `notifikasi_dosen` (
`id` int(200) NOT NULL,
  `kd_dsn` varchar(10) NOT NULL,
  `status_dilihat` enum('belum','sudah') NOT NULL,
...
--
-- Dumping data for table `notifikasi_dosen`
--

INSERT INTO `notifikasi_dosen` (`id`, `kd_dsn`, `status_dilihat`, `seminar`, `jadwal`) VALUES
(1, 'ADC', 'belum', 'seminar proposal', '2018-12-31'),
(2, 'AML', 'sudah', 'seminar proposal', '2018-12-31'),
(3, 'AMS', 'belum', 'seminar proposal', '2018-12-31'),
(4, 'ANL', 'sudah', 'seminar proposal', '2018-12-31'),
(5, 'ANS', 'belum', 'seminar proposal', '2018-12-31'),
(6, 'ASH', 'belum', 'seminar proposal', '2018-12-31'),
(7, 'BHQ', 'belum', 'seminar proposal', '2018-12-31'),
(8, 'BM', 'belum', 'seminar proposal', '2018-12-31'),
(9, 'DDA', 'belum', 'seminar proposal', '2018-12-31'),
(10, 'DGW', 'belum', 'seminar proposal', '2018-12-31'),
(11, 'DLS', 'belum', 'seminar proposal', '2018-12-31'),
(12, 'DRW', 'belum', 'seminar proposal', '2018-12-31'),
(13, 'ELV', 'belum', 'seminar proposal', '2018-12-31'),
(14, 'ERN', 'belum', 'seminar proposal', '2018-12-31'),
(15, 'EVW', 'belum', 'seminar proposal', '2018-12-31'),
(16, 'FDL', 'belum', 'seminar proposal', '2018-12-31'),
(17, 'HDZ', 'belum', 'seminar proposal', '2018-12-31'),
(18, 'HYC', 'belum', 'seminar proposal', '2018-12-31'),
(19, 'INA', 'belum', 'seminar proposal', '2018-12-31'),
(20, 'IRT', 'sudah', 'seminar proposal', '2018-12-31'),
(21, 'IVAN', 'belum', 'seminar proposal', '2018-12-31'),
(22, 'JTT', 'belum', 'seminar proposal', '2018-12-31'),
(23, 'MAB', 'belum', 'seminar proposal', '2018-12-31'),
(24, 'MAM', 'belum', 'seminar proposal', '2018-12-31'),
(25, 'MHS', 'belum', 'seminar proposal', '2018-12-31'),
(26, 'MSL', 'belum', 'seminar proposal', '2018-12-31'),
(27, 'MYD', 'belum', 'seminar proposal', '2018-12-31'),
(28, 'NO', 'belum', 'seminar proposal', '2018-12-31'),
(29, 'OPM', 'belum', 'seminar proposal', '2018-12-31'),
(30, 'PLS', 'belum', 'seminar proposal', '2018-12-31'),
(31, 'RMA', 'belum', 'seminar proposal', '2018-12-31'),
(32, 'ROM', 'belum', 'seminar proposal', '2018-12-31'),
(33, 'SAF', 'belum', 'seminar proposal', '2018-12-31'),
(34, 'SAR', 'belum', 'seminar proposal', '2018-12-31'),
(35, 'SDF', 'belum', 'seminar proposal', '2018-12-31'),
(36, 'SJS', 'belum', 'seminar proposal', '2018-12-31'),
(37, 'SMH', 'belum', 'seminar proposal', '2018-12-31'),
(38, 'SNM', 'belum', 'seminar proposal', '2018-12-31'),
(39, 'SRS', 'belum', 'seminar proposal', '2018-12-31'),
(40, 'SWD', 'belum', 'seminar proposal', '2018-12-31'),
(41, 'SWL', 'belum', 'seminar proposal', '2018-12-31'),
(42, 'SYE', 'belum', 'seminar proposal', '2018-12-31'),
(43, 'ULFI', 'belum', 'seminar proposal', '2018-12-31'),
(44, 'VEN', 'belum', 'seminar proposal', '2018-12-31'),
(45, 'ZAR', 'belum', 'seminar proposal', '2018-12-31'),
(46, 'ADC', 'belum', 'seminar proposal', '2019-01-15'),
(47, 'AML', 'sudah', 'seminar proposal', '2019-01-15'),
(48, 'AMS', 'belum', 'seminar proposal', '2019-01-15'),
(49, 'ANL', 'sudah', 'seminar proposal', '2019-01-15'),
(50, 'ANS', 'belum', 'seminar proposal', '2019-01-15'),
(51, 'ASH', 'belum', 'seminar proposal', '2019-01-15'),
(52, 'BHQ', 'belum', 'seminar proposal', '2019-01-15'),
(53, 'BM', 'belum', 'seminar proposal', '2019-01-15'),
(54, 'DDA', 'belum', 'seminar proposal', '2019-01-15'),
(55, 'DGW', 'belum', 'seminar proposal', '2019-01-15'),
(56, 'DLS', 'belum', 'seminar proposal', '2019-01-15'),
(57, 'DRW', 'belum', 'seminar proposal', '2019-01-15'),
(58, 'ELV', 'belum', 'seminar proposal', '2019-01-15'),
(59, 'ERN', 'belum', 'seminar proposal', '2019-01-15'),
(60, 'EVW', 'belum', 'seminar proposal', '2019-01-15'),
(61, 'FDL', 'belum', 'seminar proposal', '2019-01-15'),
(62, 'HDZ', 'belum', 'seminar proposal', '2019-01-15'),
(63, 'HYC', 'belum', 'seminar proposal', '2019-01-15'),
(64, 'INA', 'belum', 'seminar proposal', '2019-01-15'),
(65, 'IRT', 'sudah', 'seminar proposal', '2019-01-15'),
(66, 'IVAN', 'belum', 'seminar proposal', '2019-01-15'),
(67, 'JTT', 'belum', 'seminar proposal', '2019-01-15'),
(68, 'MAB', 'belum', 'seminar proposal', '2019-01-15'),
(69, 'MAM', 'belum', 'seminar proposal', '2019-01-15'),
(70, 'MHS', 'belum', 'seminar proposal', '2019-01-15'),
(71, 'MSL', 'belum', 'seminar proposal', '2019-01-15'),
(72, 'MYD', 'belum', 'seminar proposal', '2019-01-15'),
(73, 'NO', 'belum', 'seminar proposal', '2019-01-15'),
(74, 'OPM', 'belum', 'seminar proposal', '2019-01-15'),
(75, 'PLS', 'belum', 'seminar proposal', '2019-01-15'),
(76, 'RMA', 'belum', 'seminar proposal', '2019-01-15'),
(77, 'ROM', 'belum', 'seminar proposal', '2019-01-15'),
(78, 'SAF', 'belum', 'seminar proposal', '2019-01-15'),
(79, 'SAR', 'belum', 'seminar proposal', '2019-01-15'),
(80, 'SDF', 'belum', 'seminar proposal', '2019-01-15'),
(81, 'SJS', 'belum', 'seminar proposal', '2019-01-15'),
(82, 'SMH', 'belum', 'seminar proposal', '2019-01-15'),
(83, 'SNM', 'belum', 'seminar proposal', '2019-01-15'),
(84, 'SRS', 'belum', 'seminar proposal', '2019-01-15'),
(85, 'SWD', 'belum', 'seminar proposal', '2019-01-15'),
(86, 'SWL', 'belum', 'seminar proposal', '2019-01-15'),
(87, 'SYE', 'belum', 'seminar proposal', '2019-01-15'),
(88, 'ULFI', 'belum', 'seminar proposal', '2019-01-15'),
(89, 'VEN', 'belum', 'seminar proposal', '2019-01-15'),
(90, 'ZAR', 'belum', 'seminar proposal', '2019-01-15'),
(91, 'ADC', 'belum', 'seminar proposal', '2019-01-08'),
(92, 'AML', 'sudah', 'seminar proposal', '2019-01-08'),
(93, 'AMS', 'belum', 'seminar proposal', '2019-01-08'),
(94, 'ANL', 'sudah', 'seminar proposal', '2019-01-08'),
(95, 'ANS', 'belum', 'seminar proposal', '2019-01-08'),
(96, 'ASH', 'belum', 'seminar proposal', '2019-01-08'),
(97, 'BHQ', 'belum', 'seminar proposal', '2019-01-08'),
(98, 'BM', 'belum', 'seminar proposal', '2019-01-08'),
(99, 'DDA', 'belum', 'seminar proposal', '2019-01-08'),
(100, 'DGW', 'belum', 'seminar proposal', '2019-01-08'),
(101, 'DLS', 'belum', 'seminar proposal', '2019-01-08'),
(102, 'DRW', 'belum', 'seminar proposal', '2019-01-08'),
(103, 'ELV', 'belum', 'seminar proposal', '2019-01-08'),
(104, 'ERN', 'belum', 'seminar proposal', '2019-01-08'),
(105, 'EVW', 'belum', 'seminar proposal', '2019-01-08'),
(106, 'FDL', 'belum', 'seminar proposal', '2019-01-08'),
(107, 'HDZ', 'belum', 'seminar proposal', '2019-01-08'),
(108, 'HYC', 'belum', 'seminar proposal', '2019-01-08'),
(109, 'INA', 'belum', 'seminar proposal', '2019-01-08'),
(110, 'IRT', 'sudah', 'seminar proposal', '2019-01-08'),
(111, 'IVAN', 'belum', 'seminar proposal', '2019-01-08'),
(112, 'JTT', 'belum', 'seminar proposal', '2019-01-08'),
(113, 'MAB', 'belum', 'seminar proposal', '2019-01-08'),
(114, 'MAM', 'belum', 'seminar proposal', '2019-01-08'),
(115, 'MHS', 'belum', 'seminar proposal', '2019-01-08'),
(116, 'MSL', 'belum', 'seminar proposal', '2019-01-08'),
(117, 'MYD', 'belum', 'seminar proposal', '2019-01-08'),
(118, 'NO', 'belum', 'seminar proposal', '2019-01-08'),
(119, 'OPM', 'belum', 'seminar proposal', '2019-01-08'),
(120, 'PLS', 'belum', 'seminar proposal', '2019-01-08'),
(121, 'RMA', 'belum', 'seminar proposal', '2019-01-08'),
(122, 'ROM', 'belum', 'seminar proposal', '2019-01-08'),
(123, 'SAF', 'belum', 'seminar proposal', '2019-01-08'),
(124, 'SAR', 'belum', 'seminar proposal', '2019-01-08'),
(125, 'SDF', 'belum', 'seminar proposal', '2019-01-08'),
(126, 'SJS', 'belum', 'seminar proposal', '2019-01-08'),
(127, 'SMH', 'belum', 'seminar proposal', '2019-01-08'),
(128, 'SNM', 'belum', 'seminar proposal', '2019-01-08'),
(129, 'SRS', 'belum', 'seminar proposal', '2019-01-08'),
(130, 'SWD', 'belum', 'seminar proposal', '2019-01-08'),
(131, 'SWL', 'belum', 'seminar proposal', '2019-01-08'),
(132, 'SYE', 'belum', 'seminar proposal', '2019-01-08'),
(133, 'ULFI', 'belum', 'seminar proposal', '2019-01-08'),
(134, 'VEN', 'belum', 'seminar proposal', '2019-01-08'),
(135, 'ZAR', 'belum', 'seminar proposal', '2019-01-08'),
(136, 'ADC', 'belum', 'seminar proposal', '2020-02-14'),
(137, 'AJU', 'belum', 'seminar proposal', '2020-02-14'),
(138, 'AML', 'sudah', 'seminar proposal', '2020-02-14'),
(139, 'AMS', 'belum', 'seminar proposal', '2020-02-14'),
(140, 'ANL', 'sudah', 'seminar proposal', '2020-02-14'),
(141, 'ANS', 'belum', 'seminar proposal', '2020-02-14'),
(142, 'ASH', 'belum', 'seminar proposal', '2020-02-14'),
(143, 'BHQ', 'belum', 'seminar proposal', '2020-02-14'),
(144, 'BM', 'belum', 'seminar proposal', '2020-02-14'),
(145, 'DDA', 'belum', 'seminar proposal', '2020-02-14'),
(146, 'DGW', 'belum', 'seminar proposal', '2020-02-14'),
(147, 'DLS', 'belum', 'seminar proposal', '2020-02-14'),
(148, 'DRW', 'belum', 'seminar proposal', '2020-02-14'),
(149, 'ELV', 'belum', 'seminar proposal', '2020-02-14'),
(150, 'ERN', 'belum', 'seminar proposal', '2020-02-14'),
(151, 'EVW', 'belum', 'seminar proposal', '2020-02-14'),
(152, 'FDL', 'belum', 'seminar proposal', '2020-02-14'),
(153, 'HDZ', 'belum', 'seminar proposal', '2020-02-14'),
(154, 'HYC', 'belum', 'seminar proposal', '2020-02-14'),
(155, 'INA', 'belum', 'seminar proposal', '2020-02-14'),
(156, 'IRT', 'belum', 'seminar proposal', '2020-02-14'),
(157, 'IVAN', 'belum', 'seminar proposal', '2020-02-14'),
(158, 'JTT', 'belum', 'seminar proposal', '2020-02-14'),
(159, 'MAB', 'belum', 'seminar proposal', '2020-02-14'),
(160, 'MAM', 'belum', 'seminar proposal', '2020-02-14'),
(161, 'MHS', 'belum', 'seminar proposal', '2020-02-14'),
(162, 'MSL', 'belum', 'seminar proposal', '2020-02-14'),
(163, 'MYD', 'belum', 'seminar proposal', '2020-02-14'),
(164, 'NO', 'belum', 'seminar proposal', '2020-02-14'),
(165, 'OPM', 'belum', 'seminar proposal', '2020-02-14'),
(166, 'PLS', 'belum', 'seminar proposal', '2020-02-14'),
(167, 'RMA', 'belum', 'seminar proposal', '2020-02-14'),
(168, 'ROM', 'belum', 'seminar proposal', '2020-02-14'),
(169, 'SAF', 'belum', 'seminar proposal', '2020-02-14'),
(170, 'SAR', 'belum', 'seminar proposal', '2020-02-14'),
(171, 'SDF', 'belum', 'seminar proposal', '2020-02-14'),
(172, 'SJS', 'belum', 'seminar proposal', '2020-02-14'),
(173, 'SMH', 'belum', 'seminar proposal', '2020-02-14'),
(174, 'SNM', 'belum', 'seminar proposal', '2020-02-14'),
(175, 'SRS', 'belum', 'seminar proposal', '2020-02-14'),
(176, 'SWD', 'belum', 'seminar proposal', '2020-02-14'),
(177, 'SWL', 'belum', 'seminar proposal', '2020-02-14'),
(178, 'SYE', 'belum', 'seminar proposal', '2020-02-14'),
(179, 'ULFI', 'belum', 'seminar proposal', '2020-02-14'),
(180, 'VEN', 'belum', 'seminar proposal', '2020-02-14'),
(181, 'ZAR', 'belum', 'seminar proposal', '2020-02-14'),
(182, 'ADC', 'belum', 'seminar hasil', '2021-03-26'),
(183, 'AML', 'belum', 'seminar hasil', '2021-03-26'),
(184, 'AMS', 'belum', 'seminar hasil', '2021-03-26'),
(185, 'ANL', 'belum', 'seminar hasil', '2021-03-26'),
(186, 'ANS', 'belum', 'seminar hasil', '2021-03-26'),
(187, 'ASH', 'belum', 'seminar hasil', '2021-03-26'),
(188, 'BHQ', 'belum', 'seminar hasil', '2021-03-26'),
(189, 'BM', 'belum', 'seminar hasil', '2021-03-26'),
(190, 'DDA', 'belum', 'seminar hasil', '2021-03-26'),
(191, 'DGW', 'belum', 'seminar hasil', '2021-03-26'),
(192, 'DLS', 'belum', 'seminar hasil', '2021-03-26'),
(193, 'DRW', 'belum', 'seminar hasil', '2021-03-26'),
(194, 'ELV', 'belum', 'seminar hasil', '2021-03-26'),
(195, 'ERN', 'belum', 'seminar hasil', '2021-03-26'),
(196, 'EVW', 'belum', 'seminar hasil', '2021-03-26'),
(197, 'FDL', 'belum', 'seminar hasil', '2021-03-26'),
(198, 'HDZ', 'belum', 'seminar hasil', '2021-03-26'),
(199, 'HYC', 'belum', 'seminar hasil', '2021-03-26'),
(200, 'INA', 'belum', 'seminar hasil', '2021-03-26'),
(201, 'IRT', 'belum', 'seminar hasil', '2021-03-26'),
(202, 'IVAN', 'belum', 'seminar hasil', '2021-03-26'),
(203, 'JTT', 'belum', 'seminar hasil', '2021-03-26'),
(204, 'MAB', 'belum', 'seminar hasil', '2021-03-26'),
(205, 'MAM', 'belum', 'seminar hasil', '2021-03-26'),
(206, 'MHS', 'belum', 'seminar hasil', '2021-03-26'),
(207, 'MSL', 'belum', 'seminar hasil', '2021-03-26'),
(208, 'MYD', 'belum', 'seminar hasil', '2021-03-26'),
(209, 'NO', 'belum', 'seminar hasil', '2021-03-26'),
(210, 'OPM', 'belum', 'seminar hasil', '2021-03-26'),
(211, 'PLS', 'belum', 'seminar hasil', '2021-03-26'),
(212, 'RMA', 'belum', 'seminar hasil', '2021-03-26'),
(213, 'ROM', 'belum', 'seminar hasil', '2021-03-26'),
(214, 'SAF', 'belum', 'seminar hasil', '2021-03-26'),
(215, 'SAR', 'belum', 'seminar hasil', '2021-03-26'),
(216, 'SDF', 'belum', 'seminar hasil', '2021-03-26'),
(217, 'SJS', 'belum', 'seminar hasil', '2021-03-26'),
(218, 'SMH', 'belum', 'seminar hasil', '2021-03-26'),
(219, 'SNM', 'belum', 'seminar hasil', '2021-03-26'),
(220, 'SRS', 'belum', 'seminar hasil', '2021-03-26'),
(221, 'SWD', 'belum', 'seminar hasil', '2021-03-26'),
(222, 'SYE', 'belum', 'seminar hasil', '2021-03-26'),
(223, 'ULFI', 'belum', 'seminar hasil', '2021-03-26'),
(224, 'VEN', 'belum', 'seminar hasil', '2021-03-26'),
(225, 'ZAR', 'belum', 'seminar hasil', '2021-03-26'),
(226, 'QWO', 'belum', 'seminar hasil', '2021-03-26'),
(227, 'HXG', 'belum', 'seminar hasil', '2021-03-26'),
(228, 'MSF', 'belum', 'seminar hasil', '2021-03-26');
...
(338, NULL, '141402190', 'BHQ', 'ERN'),
(339, NULL, '141402180', 'BHQ', 'ERN'),
(340, NULL, '141402180', 'BHQ', 'ERN'),
(341, NULL, '141402199', NULL, NULL),
(342, NULL, '141402222', NULL, NULL),
(343, NULL, '141402223', NULL, NULL),
(344, NULL, '141402330', NULL, NULL),
(345, NULL, '141402400', NULL, NULL);
...
(340, NULL, '141402190', 'AML', 'HYC'),
(342, NULL, '141402180', 'ANL', 'ANS'),
(343, NULL, '141402199', 'NO', 'NO'),
(344, NULL, '141402222', 'AJU', 'NO'),
(345, NULL, '141402223', 'ANL', 'IRT'),
(346, NULL, '141402330', 'BHQ', 'NO'),
(347, NULL, '141402400', 'MSF', 'NO');
...
`id_pengajuan` int(11) NOT NULL,
  ...
  `status_validasi` enum('sudah','belum','ditolak') NOT NULL,
  ...
  `status_penentuan_dopim` enum('belum','sudah') NOT NULL,
  `status_plagiarisme` enum('belum_dikonfirmasi','plagiat','original','') NOT NULL
...
INSERT INTO `pengajuan_judul` (`id_pengajuan`, `nim`, `judul_diajukan`, `judul_diajukan_mahasiswa`, `ilmu1`, `ilmu2`, `calon_dopim1`, `calon_dopim2`, `tgl_pengajuan`, `judul`, `latar_belakang`, `rumusan_masalah`, `metodologi`, `referensi`, `status_kelayakan`, `hasil_uji_kelayakan`, `upload`, `status`, `jenis_TA`, `ringkasan`, `keywords`, `file`, `status_validasi`, `catatan_validasi`, `status_kelayakan_sempro`, `status_kelayakan_semhas`, `status_kelayakan_sidang`, `status_penentuan_dopim`, `status_plagiarisme`) VALUES
(1, '141402153', 'dosen', 'mahasiswa', 'Multimedia', 'Knowledge Management and Data Science', 'DDA', 'MAM', '2018-07-19', 'judul ta', '', '', '', '', 'ditolak', 'catatan perbaikan', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_2.pdf', 'belum', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'sudah', 'original'),
(2, '141402153', 'dosen', '', 'Multimedia', 'Knowledge Management and Data Science', 'AML', 'IVAN', '2018-07-19', 'judul ta', '', '', '', '', 'diterima', 'tes', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_21.pdf', 'belum', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'sudah', 'original'),
(3, '191402001', 'dosen', 'mahasiswa', 'Knowledge Management and Data Science', 'Multimedia', 'BHQ', 'DGW', '2018-10-24', 'Kegiatan 1', '', '', '', '', 'ditolak', 'ada perbaikan', '', 'applied', 'skripsi', '', '', '1-s2_0-S0264127517311620-main.pdf', 'belum', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'sudah', 'original'),
(4, '191402001', 'dosen', '', 'Knowledge Management and Data Science', 'Knowledge Management and Data Science', 'BHQ', 'DGW', '2018-10-24', 'test', '', '', '', '', 'diterima', '', '', 'applied', 'skripsi', '', '', '1-s2_0-S1877050917320501-main.pdf', 'belum', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'sudah', 'original'),
(5, '201402001', 'dosen', 'mahasiswa', 'Multimedia', 'Computer System', 'ANL', 'ELV', '2018-10-25', 'Judul berita', '', '', '', '', 'diterima', '', '', 'applied', 'skripsi', '', '', '1-s2_0-S1877050917319130-main.pdf', 'belum', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'sudah', 'original'),
(6, '201402009', 'dosen', '', 'Multimedia', 'Computer System', 'BM', 'FDL', '2018-10-25', 'judul', '', '', '', '', 'ditolak', 'hguyg', '', 'applied', 'skripsi', '', '', '1-s2_0-S0264127517311620-main1.pdf', 'belum', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'sudah', 'original'),
(7, '201402009', 'dosen', '', 'Multimedia', 'Computer System', 'BM', 'FDL', '2018-10-25', 'judul2', '', '', '', '', 'diterima', '', '', 'applied', 'skripsi', '', '', '1-s2_0-S0264127517311620-main2.pdf', 'belum', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'sudah', 'original'),
(8, '191402002', 'dosen', '', 'Multimedia', 'Computer System', 'BHQ', 'DDA', '2018-10-25', 'Judul berita', '', '', '', '', 'diterima', '', '', 'applied', 'skripsi', '', '', '1-s2_0-S0264127517311620-main3.pdf', 'belum', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'sudah', 'original'),
(9, '191402003', 'dosen', 'mahasiswa', 'Multimedia', 'Computer System', 'BHQ', 'DDA', '2018-10-30', 'Test', '', '', '', '', 'diterima', '', '', 'applied', 'skripsi', '', '', '', 'ditolak', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(11, '141402154', 'dosen', '', 'Multimedia', 'Computer System', 'AML', 'NO', '2018-11-16', 'Judul 1', '', '', '', '', 'diterima', 'Perhatikan Latar Belakangnya', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_1.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(12, '141402155', 'dosen', '', 'Multimedia', 'Computer System', 'ANL', 'BHQ', '2018-11-16', 'Test', '', '', '', '', 'diterima', 'Lanjutkan', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_11.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(13, '141402156', 'dosen', '', 'Multimedia', 'Computer System', 'AML', 'ASH', '2018-11-16', 'test', '', '', '', '', 'diterima', '', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_12.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(14, '141402157', 'dosen', '', 'Multimedia', 'Computer System', 'DGW', 'NO', '2018-11-16', 'Judul Terkini', '', '', '', '', 'ditolak', 'Judul dan Latar Belakang Tidak Sinkron', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_13.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(15, '141402157', 'dosen', '', 'Multimedia', 'Multimedia', 'AML', 'ADC', '2018-11-16', 'Judul Terkini 2', '', '', '', '', 'diterima', 'Lanjutkan Penelitiannya', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_14.pdf', 'sudah', '', 'layak', 'layak', 'layak', 'belum', 'original'),
(16, '141402158', 'dosen', '', 'Multimedia', 'Computer System', 'AML', 'ASH', '2018-11-19', 'Test', '', '', '', '', 'diterima', '', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_15.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(17, '141402050', 'dosen', '', 'Multimedia', 'Computer System', 'ANL', 'BHQ', '2018-11-22', 'Judul Pertama', '', '', '', '', 'diterima', 'lanjutkan', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_16.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(18, '141402051', 'dosen', '', 'Multimedia', 'Computer System', 'NO', 'NO', '2018-11-22', 'Test 1', '', '', '', '', 'diterima', 'oke', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_17.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(19, '141402052', 'dosen', '', 'Computer System', 'Multimedia', 'NO', 'NO', '2018-11-22', 'test', '', '', '', '', 'belum dikonfirmasi', '', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_18.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(20, '141402220', 'dosen', '', 'Computer System', 'Multimedia', 'ANL', 'BHQ', '2018-11-22', 'test', '', '', '', '', 'diterima', '', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_19.pdf', 'sudah', '', 'layak', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(21, '141402200', 'dosen', '', 'Multimedia', 'Computer System', 'NO', 'NO', '2018-11-24', 'Sistem Modelling 3D Bangunan Berbasis Augmented Reality', '', '', '', '', 'ditolak', 'Algoritma dan Penelitian kurang sesuai', '', 'applied', 'skripsi', '', '', '6_Vector_Surveillance__Control.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(22, '141402200', 'dosen', '', 'Multimedia', 'Computer System', 'ANL', 'RMA', '2018-11-24', 'Modelling 3D Bangunan Berbasis Augmented Reality', '', '', '', '', 'ditolak', '', '', 'applied', 'skripsi', '', '', '1-s2_0-S1877050917319130-main1.pdf', 'sudah', '', 'tidak layak', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(23, '141402190', 'dosen', '', 'Multimedia', 'Multimedia', 'AML', 'HYC', '2018-12-12', 'judul', '', '', '', '', 'diterima', 'ajsad sadsa', '', 'applied', 'skripsi', '', '', 'Form_Pengajuan_Judul_-_Revisi_110.pdf', 'sudah', '', 'layak', 'layak', 'layak', 'belum', 'original'),
(25, '141402180', 'dosen', '', 'Multimedia', 'Computer System', 'ERN', 'NO', '2018-12-17', 'Riset 1', '', '', '', '', 'ditolak', 'perbaiki latar belakang', '', 'applied', 'skripsi', '', '', 'PengajuanJudul_141402180_AuliaAmirullah7.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'original'),
(26, '141402180', 'dosen', '', 'Multimedia', 'Computer System', 'ANL', 'ANS', '2018-12-17', 'Judul IT', '', '', '', '', 'diterima', 'lanjutkan', '', 'applied', 'skripsi', '', '', 'PengajuanJudul_141402180_AuliaAmirullah8.pdf', 'sudah', '', 'layak', 'layak', 'layak', 'sudah', 'original'),
(27, '141402199', 'dosen', '', 'Multimedia', 'Computer System', 'NO', 'NO', '2018-12-20', 'test', '', '', '', '', 'belum dikonfirmasi', '', '', 'applied', 'skripsi', '', '', 'PengajuanJudul_141402199_141402199.pdf', 'belum', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'belum_dikonfirmasi'),
(28, '141402222', 'dosen', '', 'Computer System', 'Multimedia', 'AJU', 'NO', '2020-02-13', 'Sistem A', '', '', '', '', 'belum dikonfirmasi', '', '', 'applied', 'skripsi', '<p>rergegwe</p>\r\n', 'Artificial Intelligence, Cosine Similarity, Natural Language Generation,Machine Learning', 'PengajuanJudul_141402222_Abdullah.pdf', 'belum', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'belum_dikonfirmasi'),
(29, '141402223', 'dosen', '', 'Computer System', 'Multimedia', 'ANL', 'IRT', '2020-02-13', 'Sistem Keamanan Informasi dengan Algoritma A', '', '', '', '', 'diterima', 'Perbaikan pada Arsitektur Umum', '', 'applied', 'skripsi', '<p>ashgdbjkasbd cxasjifhsajk xcwsedjihrfkasj</p>\r\n', 'Sensor,Tata Surya', 'PengajuanJudul_141402223_AbdulHakim.pdf', 'sudah', '', 'layak', 'belum dikonfirmasi', 'belum dikonfirmasi', 'sudah', 'original'),
(34, '141402330', 'dosen', '', 'Multimedia', 'Computer System', 'ANL', 'NO', '2020-03-25', 'Sistem A', '', '', '', '', 'belum dikonfirmasi', '', '', 'applied', 'skripsi', '<p>fregerfws rfvgefdvg</p>\r\n', 'sdfwedf,sdfsdfasdf,sdfasdfsdf', 'PengajuanJudul_141402330_1414023304.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'belum_dikonfirmasi'),
(35, '141402400', 'dosen', '', 'Multimedia', 'Computer System', 'MSF', 'NO', '2020-03-28', 'sdfasdas', '', '', '', '', 'belum dikonfirmasi', '', '', 'applied', 'skripsi', '<p>asdasdasdas</p>\r\n', '', 'PengajuanJudul_141402400_141402400.pdf', 'sudah', '', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum', 'belum_dikonfirmasi');

--
-- Triggers `pengajuan_judul`
--
DELIMITER //
CREATE TRIGGER `riwayat_penolakan_pengajuan` AFTER UPDATE ON `pengajuan_judul`
 FOR EACH ROW BEGIN
...
--
-- Table structure for table `penilaian_semhas`
--

CREATE TABLE IF NOT EXISTS `penilaian_semhas` (
`id` int(225) NOT NULL,
  `dosen` char(5) NOT NULL,
  `status_dosen` enum('pembimbing1','pembimbing2','pembanding1','pembanding2') NOT NULL,
  `nim` char(9) NOT NULL,
...
--
-- Dumping data for table `penilaian_semhas`
--
...
(3, 'AML', 'pembimbing1', '141402190', '23', '8', 2, 5, 10, 10, 30, 2, 10, 69, 'B'),
(4, 'BHQ', 'pembanding1', '141402190', '23', '8', 2, 10, 10, 10, 10, 2, 0, 44, 'D'),
(5, 'ANL', 'pembimbing1', '141402180', '26', '8', 3, 10, 10, 25, 35, 2, 10, 95, 'A'),
(6, 'ANS', 'pembimbing2', '141402180', '26', '8', 3, 10, 15, 20, 25, 2, 10, 85, 'A'),
(7, 'ANL', 'pembimbing1', '141402180', '26', '13', 3, 10, 10, 25, 30, 2, 10, 90, 'A'),
(8, 'ANS', 'pembimbing2', '141402180', '26', '13', 3, 10, 15, 25, 35, 2, 10, 100, 'A'),
(9, 'BHQ', 'pembanding1', '141402180', '26', '13', 3, 10, 15, 24, 35, 2, 10, 99, 'A');

-- --------------------------------------------------------

--
-- Table structure for table `penilaian_sempro`
--

CREATE TABLE IF NOT EXISTS `penilaian_sempro` (
`id` int(225) NOT NULL,
...
--
-- Dumping data for table `penilaian_sempro`
--
...
(9, 'AML', '141402190', '23', 10, 'terima', 'ghjgh hj', 'ganti', '', 'perbaiki', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'layak'),
(10, 'ANL', '141402180', '26', 12, 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'layak'),
(11, 'ANS', '141402180', '26', 12, 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'layak'),
(12, 'ANL', '141402223', '29', 19, 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'layak'),
(13, 'AML', '141402223', '29', 19, 'terima', '', 'terima', '', 'terima', '', 'perbaiki', 'werfwe                                                                                                                                                                ', 'terima', '', 'terima', '', 'terima', '', 'terima', '', 'layak');
...
CREATE TABLE IF NOT EXISTS `penilaian_sidang` (
`id` int(225) NOT NULL,
  `dosen` char(5) NOT NULL,
  `status_dosen` enum('pembimbing1','pembimbing2','pembanding1','pembanding2') NOT NULL,
  `nim` char(9) NOT NULL,
...
(3, 'AML', 'pembimbing1', '141402190', '23', '11', 25, 20, 20, 20, 85, 'A'),
(4, 'BHQ', 'pembanding1', '141402190', '23', '11', 20, 20, 20, 20, 80, 'B+'),
(5, 'ANL', 'pembimbing1', '141402180', '26', '11', 25, 25, 25, 20, 95, 'A'),
(6, 'ANL', 'pembimbing1', '141402180', '26', '14', 25, 25, 25, 25, 100, 'A'),
(7, 'BHQ', 'pembanding1', '141402180', '26', '14', 25, 25, 25, 25, 100, 'A'),
(8, 'ERN', 'pembanding2', '141402180', '26', '14', 25, 25, 25, 25, 100, 'A');

-- --------------------------------------------------------

--
-- Table structure for table `penilaian_uji_program`
--

CREATE TABLE IF NOT EXISTS `penilaian_uji_program` (
`id` int(200) NOT NULL,
  `nim` char(9) NOT NULL,
...
--
-- Dumping data for table `penilaian_uji_program`
--
...
(3, '141402190', 'pembimbing1', 40, 5, 20, 5, 20, 90),
(4, '141402180', 'pembimbing1', 30, 10, 20, 10, 20, 90);
...
--
-- Triggers `program_studi`
--
DELIMITER //
CREATE TRIGGER `updprodi` AFTER UPDATE ON `program_studi`
 FOR EACH ROW BEGIN 
...
--
-- Table structure for table `riwayat_penolakan_pengajuan`
--

CREATE TABLE IF NOT EXISTS `riwayat_penolakan_pengajuan` (
...
--
-- Dumping data for table `riwayat_penolakan_pengajuan`
--
...
(11, 25, 'PengajuanJudul_141402180_AuliaAmirullah7.pdf', '2018-12-17 17:06:32', 'ditolak', 'Foto perbaiki ya'),
(12, 25, 'PengajuanJudul_141402180_AuliaAmirullah7.pdf', '2018-12-17 17:06:56', 'ditolak', 'Foto perbaiki ya'),
(13, 9, '', '2018-12-19 17:19:01', 'ditolak', ''),
(14, 28, 'PengajuanJudul_141402222_Abdullah.pdf', '2020-02-13 16:15:30', 'ditolak', 'Belum Lengkap'),
(15, 9, '', '2020-02-14 10:37:20', 'ditolak', '');
...
(6, 'Judul Terkini 2', '141402157', 'Charissa ', 'TIF', 'AML', 'ADC', 10, 2018, 'sidang', 'Multimedia', 'Multimedia'),
...
(12, 'judul', '141402190', 'Muhammad Arief', 'TIF', 'AML', 'HYC', 12, 2018, 'lulus', 'Multimedia', 'Multimedia'),
(13, 'Judul IT', '141402180', 'Aulia Amirullah', 'TIF', 'ANL', 'ANS', 12, 2018, 'sudah sidang', 'Multimedia', 'Computer System'),
(14, 'Sistem Keamanan Informasi dengan Algoritma A', '141402223', 'Abdul Hakim', 'TIF', 'ANL', 'IRT', 0, 0000, 'seminar hasil', 'Computer System', 'Multimedia');

-- --------------------------------------------------------

--
-- Table structure for table `skripsi_nim`
--

CREATE TABLE IF NOT EXISTS `skripsi_nim` (
`id_skripsi` int(20) NOT NULL,
  `nim` varchar(9) NOT NULL,
...
--
-- Dumping data for table `skripsi_nim`
--
...
(313, '141402190', 'judul', 12, 2018, NULL, '2018-10-31', '2018-12-28', 'skripsi', NULL, NULL),
(314, '141402180', 'Judul IT', 12, 2018, NULL, '2018-12-29', '2018-12-31', 'skripsi', NULL, NULL),
(315, '141402223', 'Sistem Keamanan Informasi dengan Algoritma A', 0, NULL, NULL, NULL, NULL, 'skripsi', NULL, NULL);

--
-- Triggers `skripsi_nim`
--
DELIMITER //
CREATE TRIGGER `log_pencatatan` AFTER INSERT ON `skripsi_nim`
 FOR EACH ROW BEGIN
...
('maya', '11eebd8a5cdad10d2cab80732f10d175', 2, 'MSL', '', ''),
...
('ade', 'fd830bcaa3f35fc672da7869b70ede13', 2, 'ADC', '', ''),
('141402158', '4852f3741d777cd589a2a8688e4d691f', 3, '', '', ''),
('andri', 'ac80dd34b140bddc584785e92b25e7ca', 2, 'MAB', '', ''),
('baihaqi', '8e76e12f1d3a3907c8ee809b912f2548', 2, 'BHQ', '', ''),
('141402050', '5f0046276e5ae3c255772ac9881bb699', 3, '', '', ''),
('ainul', '48d492a28d2827f2caab6a278b37306c', 2, 'ANL', '', ''),
...
('rachmat', 'aeb0b32ba86edb25e20adb530cb5b737', 2, 'RMA', '', ''),
('sekprodi_ti', '42278c9513bfe97fd9f4c3f73e845522', 5, '', 'TIF', 'Sekretaris Program Studi S1-Teknologi Informasi'),
('141402190', 'b5a5522564f6c0f69d3546d096fc4762', 3, '', '', ''),
('141402180', '5aba4f1d50bfd071702663dff44ad96a', 3, '', '', ''),
('ayu', 'a7a26e44b2b172f258a00fc112c5d578', 2, 'ANS', '', ''),
('141402199', '18148b22349f38add6e527eff1ed0ae1', 3, '', '', ''),
('erna', '135ba3f3269a20f1653a9b7379cf9c1d', 2, 'ERN', '', ''),
('141402201', '110013c2e452ac8df91f33d4ec68bf58', 3, '', '', ''),
('arjuna', '2ea41863add9406830e378b9345ffe3b', 2, 'AJU', '', ''),
('141402202', '215472d6060d525ac99ef467bdf3647f', 3, '', '', ''),
('141402222', 'deff91b7cf5627e2a556f947ea47acba', 3, '', '', ''),
('141402223', '34e11910a5f54016ab33b95f91b0406b', 3, '', '', ''),
('irianto', 'cb29f7e5c0961f02a631718acab78e2b', 2, 'IRT', '', ''),
('validator', '8d6c391e7cb39133c91b73281a24f21f', 7, '', '', 'Validator Plagiarisme'),
('141402330', '4b659733e9424a92d118746afea59918', 3, '', '', ''),
('admin_ilk', '0c43a1d7fd906993c1910017e7a603ad', 1, '', 'ILK', 'Admin S1 Ilmu Komputer'),
('kepala_lab_ti', '5975dbd2b08b41e878d3acc803f7704a', 6, '', 'TIF', 'Kepala Laboratorium S1-Teknologi Informasi'),
('kepala_lab_ilk', 'c60a8d6ec597357e582dddd73cdb4215', 6, '', 'ILK', 'Kepala Laboratorium S1-Ilmu Komputer'),
('sembiring', '6a0a66ff13961fb233e241e8b932815a', 2, 'BM', '', ''),
('dedy', 'f2bb37122e23ffafdcc0b320a593026b', 2, 'DDA', '', ''),
('dani', 'd37e193ae4f1cf4a3613f1eb43d07f1a', 2, 'DGW', '', ''),
('elviawaty', '20c5a3b6c53d3fcd0b1ff3623e3b7624', 2, 'ELV', '', ''),
('fadly', '801417390126151c7796929f2f0419f4', 2, 'FDL', '', ''),
('ivan', '20315895fc2ed1d6a217c711b7f2a363', 2, 'IVAN', '', ''),
('anggi', '8c0e26f61ec4198e99b5486d7f6d0e60', 2, 'MAM', '', ''),
('mahyudin', '579c3dbebe6e8b25cea6f250119fdb70', 2, 'MYD', '', ''),
('opim', '78ad2710c3ed963c2cf83fe9b26555ba', 2, 'OPM', '', ''),
('romi', '7b95d617799476e290d9299905bd325a', 2, 'ROM', '', ''),
('safri', 'b5fc629d61d98210b822df7eb7dcef08', 2, 'SAF', '', ''),
('sarah', '88add9924fc46fff57ff902cb81e905d', 2, 'SAR', '', ''),
('seniman', '5379b2df0b198837128025bea2cd5e66', 2, 'SNM', '', ''),
('syawal', 'b275b474376ec88ead9ecedcd1a0c8fc', 2, 'SWD', '', ''),
('ulfi', 'ff03ea80e19961a30e7bdeacc3db2fde', 2, 'ULFI', '', ''),
('marischa', '3d2d13bce0e824bf25be1d238e07250f', 2, 'VEN', '', ''),
('zarlis', 'd88fe7193925cf90e2742472cac92b7d', 2, 'ZAR', '', ''),
('amer', 'bdd66b0a0fd947d9232911730f6a3f7e', 2, 'AMS', '', ''),
('agus', 'ce03e9454050f602f51463a9b7ce4f8e', 2, 'ASH', '', ''),
('dahlan', '653f84cc12807dda26fdf3e21a2f728b', 2, 'DLS', '', ''),
('dian', '779c2213eae0bf6c79af54ea69ee5e4b', 2, 'DRW', '', ''),
('elviwani', '0c726dd97080732bfac1cdf4fef50f72', 2, 'EVW', '', ''),
('handrizal', '0d25ee1970713082e43e4094d6d8aca6', 2, 'HDZ', '', ''),
('herriyance', '7d7c22dd965e11b6d4d2b0c281d84233', 2, 'HYC', '', ''),
('marihat', '6e441d8150bca15e5c905733050276c4', 2, 'MHS', '', ''),
('poltak', '6d434efb74409bd45fc83dcdae284374', 2, 'PLS', '', ''),
('Sajadin Sembiring, S.Si., M.Comp. Sc', '6610a1a2f5a8a6d5760f1bdb5a16eb70', 2, 'SJS', '', ''),
('sri', 'b22558ed8a4ee2deff60a7f88341bff5', 2, 'SMH', '', ''),
('syahriol', 'e8f9d0f17a0c0ba6ad11a178c186d04a', 2, 'SRS', '', ''),
('syahril', '734f8cfaa2f9560c635956f91bf37318', 2, 'SYE', '', ''),
('141402400', '8fd25be86782d46410adbf020a7069f1', 3, '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `validasi_penggandaan`
--

CREATE TABLE IF NOT EXISTS `validasi_penggandaan` (
`id` int(255) NOT NULL,
...
--
-- Dumping data for table `validasi_penggandaan`
--
...
(5, 23, '141402190', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi'),
(6, 26, '141402180', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi');

-- --------------------------------------------------------

--
-- Table structure for table `validasi_semhas`
--

CREATE TABLE IF NOT EXISTS `validasi_semhas` (
`id` int(255) NOT NULL,
...
--
-- Dumping data for table `validasi_semhas`
--
...
(4, '23', '141402190', 'checked', 'checked', 'checked', 'checked'),
(5, '26', '141402180', 'checked', 'checked', 'checked', 'checked');

-- --------------------------------------------------------

--
-- Table structure for table `validasi_sempro`
--

CREATE TABLE IF NOT EXISTS `validasi_sempro` (
`id` int(255) NOT NULL,
  `id_pengajuan_judul` int(255) NOT NULL,
  `nim` char(9) NOT NULL,
  `fotokopi_krs` enum('checked','belum dikonfirmasi','unchecked','') NOT NULL,
...
--
-- Dumping data for table `validasi_sempro`
--
...
(17, 23, '141402190', 'checked', 'checked', 'checked'),
(18, 26, '141402180', 'checked', 'checked', 'checked'),
(19, 29, '141402223', 'checked', 'checked', 'checked');

-- --------------------------------------------------------

--
-- Table structure for table `validasi_sidang`
--
...
--
-- Dumping data for table `validasi_sidang`
--
...
(12, 23, '141402190', 'checked', 'checked', 'checked', 'checked', 'checked', 'checked', 'checked'),
(13, 15, '141402157', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi', 'belum dikonfirmasi'),
(14, 26, '141402180', 'checked', 'checked', 'checked', 'checked', 'checked', 'checked', 'checked');

-- --------------------------------------------------------

--
-- Stand-in structure for view `v_cari_mahasiswa`
--
CREATE TABLE IF NOT EXISTS `v_cari_mahasiswa` (
`nim` char(9)
,`nama` varchar(30)
,`id_PS` char(9)
...
--
-- Table structure for table `v_disertasi`
--

CREATE TABLE IF NOT EXISTS `v_disertasi` (
...
--
CREATE TABLE IF NOT EXISTS `v_dosen` (
`Kode_dosen` char(10)
...
--
-- Stand-in structure for view `v_mahasiswa_diuji`
--
CREATE TABLE IF NOT EXISTS `v_mahasiswa_diuji` (
`nim` char(9)
,`nama` varchar(30)
,`id_PS` char(9)
,`status` enum('pengajuan judul','belum sempro','belum semhas','belum sidang','sudah sidang','lulus')
...
--
-- Stand-in structure for view `v_mahasiswa_seminar`
--
CREATE TABLE IF NOT EXISTS `v_mahasiswa_seminar` (
...
--
-- Stand-in structure for view `v_pencarian_mahasiswa`
--
CREATE TABLE IF NOT EXISTS `v_pencarian_mahasiswa` (
`nim` char(9)
,`tahun_lulus` year(4)
...
--
-- Stand-in structure for view `v_pencatatan`
--
CREATE TABLE IF NOT EXISTS `v_pencatatan` (
`nim` char(9)
,`tahun_lulus` year(4)
,`bulan_lulus` int(2)
,`nomor_sk_pembimbing` varchar(20)
...
--
-- Stand-in structure for view `v_script`
--
CREATE TABLE IF NOT EXISTS `v_script` (
`id_skripsi` int(20)
,`nim` char(9)
,`nama` varchar(30)
,`kode_PS` char(5)
...
--
-- Table structure for table `v_tesis`
--

CREATE TABLE IF NOT EXISTS `v_tesis` (
...
--
-- Stand-in structure for view `v_testting`
--
CREATE TABLE IF NOT EXISTS `v_testting` (
`nim` char(9)
,`tahun_lulus` year(4)
,`bulan_lulus` int(2)
,`nomor_sk_pembimbing` varchar(20)
...
--
-- Structure for view `v_cari_mahasiswa`
--
...
--
-- Structure for view `v_mahasiswa_diuji`
--
...
--
-- Structure for view `v_mahasiswa_seminar`
--
...
--
-- Structure for view `v_pencarian_mahasiswa`
--
...
--
-- Structure for view `v_pencatatan`
--
...
--
-- Structure for view `v_testting`
--
DROP TABLE IF EXISTS `v_testting`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_testting` AS select `a`.`nim` AS `nim`,`f`.`tahun_lulus` AS `tahun_lulus`,`f`.`bulan_lulus` AS `bulan_lulus`,`b`.`nomor_sk` AS `nomor_sk_pembimbing`,`c`.`nomor_sk` AS `nomor_sk_pembanding`,`a`.`nama` AS `nama`,`j`.`nama_PS` AS `nama_PS`,`f`.`judul` AS `judul`,`b`.`pembimbing1` AS `kode_pembimbing1`,`d`.`Nama_dosen` AS `Dosen_Pembimbing1`,`b`.`pembimbing2` AS `kode_pembimbing2`,`e`.`Nama_dosen` AS `Dosen_Pembimbing2`,`c`.`pembanding1` AS `Kode_pembanding1`,`g`.`Nama_dosen` AS `Dosen_Pembanding1`,`c`.`pembanding2` AS `Kode_pembanding2`,`h`.`Nama_dosen` AS `Dosen_Pembanding2`,`i`.`nilai_uji_program` AS `nilai_uji_program`,`i`.`nilai_semhas` AS `nilai_semhas`,`i`.`nilai_sidang` AS `nilai_sidang`,`i`.`total` AS `total`,`i`.`grade` AS `grade`,`f`.`jenis_TA` AS `jenis_TA`,`f`.`ilmu1` AS `ilmu1`,`f`.`ilmu2` AS `ilmu2` from (((((((((`mahasiswa` `a` join `pembimbing` `b`) join `pembanding` `c`) join `dosen` `d`) join `dosen` `e`) join `skripsi_nim` `f`) join `dosen` `g`) join `dosen` `h`) join `nilai` `i`) join `program_studi` `j`) where ((`b`.`nim` = `a`.`nim`) and (`c`.`nim` = `a`.`nim`) and (`f`.`nim` = `a`.`nim`) and (`i`.`nim` = `a`.`nim`) and (`b`.`pembimbing1` = `d`.`Kode_dosen`) and (`b`.`pembimbing2` = `e`.`Kode_dosen`) and (`c`.`pembanding1` = `g`.`Kode_dosen`) and (`c`.`pembanding2` = `h`.`Kode_dosen`) and (`a`.`id_PS` = `j`.`id_PS`));
...
--
-- Indexes for table `batas_bimbingan`
--
...
--
-- Indexes for table `berkas_validasi`
--
ALTER TABLE `berkas_validasi`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `berkas_validasi_penguji`
--
ALTER TABLE `berkas_validasi_penguji`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `catatan_perbaikan_semhas`
--
ALTER TABLE `catatan_perbaikan_semhas`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `catatan_perbaikan_sidang`
--
...
--
-- Indexes for table `izin_seminar`
--
...
--
-- Indexes for table `kirim_aplikasi`
--
...
--
-- Indexes for table `lembar_kendali_bimbingan`
--
...
--
-- Indexes for table `mahasiswa_sidang`
--
...
--
-- Indexes for table `notifikasi_dosen`
--
...
--
-- Indexes for table `penilaian_semhas`
--
ALTER TABLE `penilaian_semhas`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `penilaian_sempro`
--
...
--
-- Indexes for table `penilaian_uji_program`
--
ALTER TABLE `penilaian_uji_program`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `riwayat_penolakan_pengajuan`
--
...
--
-- Indexes for table `skripsi_nim`
--
ALTER TABLE `skripsi_nim`
 ADD PRIMARY KEY (`id_skripsi`);

--
-- Indexes for table `validasi_penggandaan`
--
ALTER TABLE `validasi_penggandaan`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `validasi_semhas`
--
ALTER TABLE `validasi_semhas`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `validasi_sempro`
--
...
--
-- AUTO_INCREMENT for table `batas_bimbingan`
--
ALTER TABLE `batas_bimbingan`
...
--
-- AUTO_INCREMENT for table `berkas_validasi`
--
ALTER TABLE `berkas_validasi`
MODIFY `id` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=48;
--
-- AUTO_INCREMENT for table `berkas_validasi_penguji`
--
ALTER TABLE `berkas_validasi_penguji`
...
--
-- AUTO_INCREMENT for table `catatan_perbaikan_semhas`
--
ALTER TABLE `catatan_perbaikan_semhas`
MODIFY `id` int(225) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `catatan_perbaikan_sidang`
--
ALTER TABLE `catatan_perbaikan_sidang`
...
--
-- AUTO_INCREMENT for table `izin_seminar`
--
ALTER TABLE `izin_seminar`
...
--
-- AUTO_INCREMENT for table `kirim_aplikasi`
--
ALTER TABLE `kirim_aplikasi`
...
--
-- AUTO_INCREMENT for table `lembar_kendali_bimbingan`
--
ALTER TABLE `lembar_kendali_bimbingan`
...
--
ALTER TABLE `log_pencatatan`
MODIFY `id` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=299;
--
-- AUTO_INCREMENT for table `mahasiswa_sidang`
--
ALTER TABLE `mahasiswa_sidang`
...
--
ALTER TABLE `nilai`
MODIFY `id_skripsi` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=344;
--
...
--
-- AUTO_INCREMENT for table `notifikasi_dosen`
--
ALTER TABLE `notifikasi_dosen`
MODIFY `id` int(200) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=229;
--
-- AUTO_INCREMENT for table `pembanding`
--
ALTER TABLE `pembanding`
MODIFY `id` int(15) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=346;
--
-- AUTO_INCREMENT for table `pembimbing`
--
ALTER TABLE `pembimbing`
MODIFY `id` int(15) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=348;
--
...
--
-- AUTO_INCREMENT for table `penilaian_semhas`
--
ALTER TABLE `penilaian_semhas`
MODIFY `id` int(225) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `penilaian_sempro`
--
ALTER TABLE `penilaian_sempro`
MODIFY `id` int(225) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
...
--
-- AUTO_INCREMENT for table `penilaian_uji_program`
--
ALTER TABLE `penilaian_uji_program`
MODIFY `id` int(200) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `riwayat_penolakan_pengajuan`
--
ALTER TABLE `riwayat_penolakan_pengajuan`
MODIFY `id_penolakan` int(100) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `skripsi`
MODIFY `id_skripsi` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `skripsi_nim`
--
ALTER TABLE `skripsi_nim`
MODIFY `id_skripsi` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=316;
--
-- AUTO_INCREMENT for table `validasi_penggandaan`
--
ALTER TABLE `validasi_penggandaan`
MODIFY `id` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `validasi_semhas`
--
ALTER TABLE `validasi_semhas`
MODIFY `id` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `validasi_sempro`
--
ALTER TABLE `validasi_sempro`
MODIFY `id` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `validasi_sidang`
--
ALTER TABLE `validasi_sidang`
